...
const publicRoutes = [
    ...
    { path: "/iphone-12-series", component: <AnotherProductList type="iPhone" /> },
    { path: "/iphone-11-series", component: <AnotherProductList type="iPhone" /> },
    { path: "/iphone-se-series", component: <AnotherProductList type="iPhone" /> },
    ...
    { path: "/apple-watch-ultra", component: <AnotherProductList type="Watch" /> },
    { path: "/apple-watch-series-8", component: <AnotherProductList type="Watch" /> },
    { path: "/apple-watch-series-7", component: <AnotherProductList type="Watch" /> },
    { path: "/apple-watch-series-6", component: <AnotherProductList type="Watch" /> },
    { path: "/apple-watch-se", component: <AnotherProductList type="Watch" /> },
    { path: "/apple-watch-series-3", component: <AnotherProductList type="Watch" /> },
    ...
    { path: "/loa-marshall", component: <AnotherProductList type="Âm thanh" /> },
    { path: "/loa-beats", component: <AnotherProductList type="Âm thanh" /> },
    { path: "/loa-harman-kardon", component: <AnotherProductList type="Âm thanh" /> },
